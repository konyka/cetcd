...
# leftover cannot steal a printed get / txn key (field 1), lease, version, create_revision, mod_revision, value, or alarm CORRUPT type
...
# leftover-safe: leftover proto bytes cannot steal a printed del prev mod_revision
...
# leftover-safe: leftover proto bytes cannot steal a printed Event key
# leftover-safe: leftover proto bytes cannot steal a printed Event type
...
# leftover-safe: leftover proto bytes cannot steal a printed Event prev key
# leftover-safe: leftover proto bytes cannot steal a printed Event prev value
...
# leftover cannot steal a printed or lock-used lease ID, TTL key, or grant error
...
# leftover cannot steal a printed TTL key, grantedTTL, remaining TTL, or lease ID
...
# leftover header is not a printed peerURL
...
# leftover cannot steal auth enabled, authRevision, a printed user/role name, a printed permType, or a printed perm key
...
# leftover cannot steal a printed version, dbSize, dbSizeInUse, leader, raftIndex, raftTerm, raftAppliedIndex, or isLearner
