...
> Watch and LeaseKeepAlive streams (HTTP/2 preface on the client port; TLS selects ALPN `h2`).
> `cetcdctl` still uses custom frames. Snapshot / RangeStream
> over HTTP/2 stay unary-shaped — see
