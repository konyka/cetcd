...
Status leftover-safe-parses so leftover length-delimited bytes cannot steal a printed version, dbSize, dbSizeInUse, leader, `isLearner`, or alarm error (truncated version / isLearner / dbSizeInUse / leader / error fail-closes).
