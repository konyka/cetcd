...
Status leftover-safe-parses so leftover length-delimited bytes cannot steal a printed version, dbSize, `isLearner`, or alarm error (truncated version / isLearner / error fail-closes).
