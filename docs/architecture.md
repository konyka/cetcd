...
event / kv / key / Event-nested lease / Event-nested version / Event-nested create_revision / Event-nested mod_revision / Event-nested prev create_revision / Event-nested prev mod_revision fail-closes (cannot print leftover text). The Event `KeyValue` encoding uses correct
