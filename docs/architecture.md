...
length-delimited bytes cannot steal a printed Event key or type or Event lease; a truncated
event / kv / key / Event-nested lease fail-closes (cannot print leftover text). The Event `KeyValue` encoding uses correct
