...
length-delimited bytes cannot steal a printed Event key or type; a truncated
event / kv / key fail-closes (cannot print leftover text). The Event `KeyValue` encoding uses correct
