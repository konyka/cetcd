...
CETCD_TEST_CASE(server_start_peer_client_cert_without_key) {
    char dir[128];
    CETCD_ASSERT_EQ_INT(make_selfsigned_(dir, sizeof(dir)), 0);
    char cert[300], key[300];
    snprintf(cert, sizeof(cert), "%s/cert.pem", dir);
    ...
    strncpy(cfg.peer_cert_file, cert, sizeof(cfg.peer_cert_file) - 1);
    strncpy(cfg.peer_key_file, key, sizeof(cfg.peer_key_file) - 1);
    strncpy(cfg.peer_client_cert_file, cert, sizeof(cfg.peer_client_cert_file) - 1);
...
CETCD_TEST_CASE(server_start_peer_client_cert_without_listen) {
    cetcd_server_config cfg;
    memset(&cfg, 0, sizeof(cfg));
    cfg.node_id = 1;
    cfg.listen_port = 2379;
    cfg.election_tick = 10;
    cfg.heartbeat_tick = 1;
    strncpy(cfg.peer_client_cert_file, "/nonexistent/out.pem",
            sizeof(cfg.peer_client_cert_file) - 1);
    strncpy(cfg.peer_client_key_file, "/nonexistent/out.key",
...
CETCD_TEST_CASE(server_start_loads_peer_client_cert) {
    char dir[128];
    CETCD_ASSERT_EQ_INT(make_selfsigned_(dir, sizeof(dir)), 0);
    char cert[300], key[300];
    snprintf(cert, sizeof(cert), "%s/cert.pem", dir);
    ...
    strncpy(cfg.peer_key_file, key, sizeof(cfg.peer_key_file) - 1);
    strncpy(cfg.peer_client_cert_file, cert, sizeof(cfg.peer_client_cert_file) - 1);
    strncpy(cfg.peer_client_key_file, key, sizeof(cfg.peer_client_key_file) - 1);
...
CETCD_TEST_CASE(server_start_rejects_missing_peer_client_cert) {
    char dir[128];
    CETCD_ASSERT_EQ_INT(make_selfsigned_(dir, sizeof(dir)), 0);
    char cert[300], key[300];
    snprintf(cert, sizeof(cert), "%s/cert.pem", dir);
    ...
    strncpy(cfg.peer_cert_file, cert, sizeof(cfg.peer_cert_file) - 1);
    strncpy(cfg.peer_key_file, key, sizeof(cfg.peer_key_file) - 1);
    strncpy(cfg.peer_client_cert_file, "/nonexistent/cetcd-out.pem",
            sizeof(cfg.peer_client_cert_file) - 1);
    strncpy(cfg.peer_client_key_file, "/nonexistent/cetcd-out.key",
            sizeof(cfg.peer_client_key_file) - 1);

    cetcd_server *srv = cetcd_server_new(&cfg);
    CETCD_ASSERT_NOT_NULL(srv);
    CETCD_ASSERT_EQ_INT(cetcd_server_start(srv), CETCD_ERR_IO);
    cetcd_server_free(srv);
    cleanup_selfsigned_(dir);
}
...
CETCD_TEST_CASE(server_start_accepts_tls13_cipher_suites) {
    char dir[128];
    CETCD_ASSERT_EQ_INT(make_selfsigned_(dir, sizeof(dir)), 0);
    char cert[300], key[300];
    snprintf(cert, sizeof(cert), "%s/cert.pem", dir);
    ...
    strncpy(cfg.cert_file, cert, sizeof(cfg.cert_file) - 1);
    strncpy(cfg.key_file, key, sizeof(cfg.key_file) - 1);
    strncpy(cfg.cipher_suites, "TLS_AES_256_GCM_SHA384",
            sizeof(cfg.cipher_suites) - 1);
...
CETCD_TEST_LIST_BEGIN
    ...
    CETCD_TEST_ENTRY(server_start_peer_client_cert_without_key),
    ...
    CETCD_TEST_ENTRY(server_start_accepts_tls13_cipher_suites),
